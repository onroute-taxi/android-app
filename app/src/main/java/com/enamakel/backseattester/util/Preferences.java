...
import com.enamakel.backseattester.preferences.ThemePreference;
...
//            return StoryViewMode.Comment;
    ...
    public static boolean isFirstTime(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                .getBoolean(context.getString(R.string.pref_is_first_time), true);
    }
    ...
    public static void setVisited(Context context) {
        PreferenceManager.getDefaultSharedPreferences(context)
                .edit()
                .putBoolean(context.getString(R.string.pref_is_first_time), false)
                .apply();
    }
    ...
    public static boolean downloadImagesOnWifiOnly(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                .getBoolean(context.getString(R.string.pref_imagewifi), false);
    }
